...
import com.classtime.service.utils.PropertyUtil;
...
public class ConstantUtil {
    ...
    public static final String NOTIFY_URL;//notify_url = "http://dtrip.etripworld.com/pay/notifyUrl";
    //需http://格式的完整路径，不能加?id=123这类自定义参数
    //页面跳转同步通知页面路径
    public static final String RETURN_URL;//return_url = "http://dtrip.etripworld.com/pay/returnUrl";
    ...
    static {
        ...
        WEBAPP_COOKIE_DOMAIN = getProperty("webapp.cookie.domail", "localhost").trim();
